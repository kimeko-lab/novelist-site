const features = [
  {
    ...
    description:
      "Live word count, auto-save every 1.5 seconds, rich text formatting, and nothing in your way. Just you and the page.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Build your cast with full profiles, then visualize how they connect. Drag characters onto a canvas, draw relationships, and label them.",
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
  ...
  },
  {
    ...
    description:
      "See your whole story at a glance. Map plot lines across chapters on a timeline, or lay scenes out on a corkboard while you plan.",
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
  ...
  },
  {
    title: "Notes & lore",
    description:
      "Attach notes to specific scenes, characters, or chapters. Keep a codex for world-building — magic systems, factions, locations — right inside the app.",
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
  ...
  },
  {
    title: "Find & replace",
    description:
      "Search across your entire manuscript in one go. Changed a character's name halfway through? Fix it everywhere in seconds.",
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
